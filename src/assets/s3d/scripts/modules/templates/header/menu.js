      ...
      <div class="menu-nav-wrap">
        <div class="menu-nav">
          <ul>
            ...
            <li class="menu-nav-link">
              <div class="js-s3d-nav__btn" data-type="flyby" data-flyby="1" data-side="outside" data-title="${i18n.t('ctr.nav.genplan')}" data-menu-close>
                <svg data-v-a51d3662="" data-v-e742a666="" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 25 25" role="presentation" class="icon app-menu-item__icon"><g data-v-a51d3662="" class="stroke no-fill" style="stroke-width: 2.08333;"><path d="M10 18.9995H9.00002C7.90003 18.9995 7.00003 19.8995 7.00003 20.9995V23.9995H12V20.9995C12 19.8995 11.1 18.9995 10 18.9995Z" stroke-linecap="round" stroke-linejoin="round"></path><path d="M2.00011 1H17V23.9998H2.00011V1Z" stroke-linecap="round" stroke-linejoin="round"></path><path d="M17 7H23V23.9999H17V7Z" stroke-linecap="round" stroke-linejoin="round"></path><path d="M13 6H6" stroke-linecap="round" stroke-linejoin="round"></path><path d="M13 10H6" stroke-linecap="round" stroke-linejoin="round"></path><path d="M13 14H6" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>
                <span>${i18n.t('ctr.nav.masterplan')}</span>
              </div>
            </li>
            <li class="menu-nav-link">
              <div class="js-s3d-nav__btn" data-type="plannings" data-title="${i18n.t('ctr.nav.plannings')}" data-menu-close>
                ...
                <span>${i18n.t('ctr.nav.plannings_availability')}</span>
              </div>
            </li>
            <li class="menu-nav-link" ${!config.menu_tour_link ? 'style="display:none;"' : ''}>
              <div class="js-s3d-flat__3d-tour" data-href="${config.menu_tour_link}" data-menu-close>
            ...
            <li class="menu-nav-link" ${!config.menu_video_link ? 'style="display:none;"' : ''}>
              <div data-menu-close class="js-s3d-flat__3d-tour" data-href="${config.menu_video_link}">
            ...
            <li ${!config.menu_brochure_link ? 'style="display:none;"' : ''} class="menu-nav-link js-s3d-flat__3d-tour" data-menu-close data-href="${config.menu_brochure_link}">
              <div>
            ...
            <li class="menu-nav-link js-s3d-flat__3d-tour" data-href="${config.project_google_map_location}" data-menu-close>
              <div>
