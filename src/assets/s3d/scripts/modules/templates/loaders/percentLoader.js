export default function percentLoader(i18n) {
  return `
        <div class="fs-preloader-before js-fs-preloader-before">
            ...
            <div class="fs-preloader-before-precent fs-preloader-before-text-large">${i18n.t(
              'load.loading-text',
            )}</div>
            <div class="fs-preloader-before-precent fs-preloader-before-text-subtitle">${i18n.t(
              'load.loading-text-wait',
            )}</div>
