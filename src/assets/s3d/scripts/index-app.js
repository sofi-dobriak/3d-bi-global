  ...
  const controllerNode = Controller(i18n, config, `
    ...
    <div class="s3d-ctr__audio" data-s3d-audio-guide-state-marker>
      ...
      <div class="s3d-ctr__audio-open" data-s3d-audio-guide-enable>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M6.29297 11.8535L12.1465 17.707L12.8535 17L8.20703 12.3535H18V11.3535H8.20703L12.8535 6.70703L12.1465 6L6.29297 11.8535Z" fill="var(--icon-gray-200)"/>
        </svg>
      </div>
    </div>
  `);
