...
export default function MobileFlybyController(i18n) {
  ...
  return `
    <div class="MobileFlybyController">
      ...
      <button class="ButtonIconLeft ButtonIconLeft--secondary ButtonIconLeft--centered" data-open-form="" ${showElementsOnPageAttribute(['flat'])}>
  ...
  return `
    <div class="MobileFunctionsMenu" data-mobile-functions-menu >
      ...
      <div class="MobileFunctionsMenu__row">
        ...
        <div class="MobileFunctionsMenu__group" ${showElementsOnPageAttribute(flybysWithDarkTheme)}>
